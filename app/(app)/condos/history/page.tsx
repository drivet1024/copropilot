...
export default async function CondoHistoryPage() {
  ...
  if (!condo) {
    return <NoCondoConfiguredState activeHref="/condos/history" />;
  }
  ...
  return (
    <div className="space-y-8">
      <CondoSectionHeader
        ...
        activeHref="/condos/history"
      />

      <section className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm lg:p-8">
        <h1 className="text-3xl font-bold text-slate-950">Historique</h1>
        <p className="mt-3 max-w-3xl text-base leading-7 text-slate-600">
          Cette vue affichera l’historique des changements, décisions et
